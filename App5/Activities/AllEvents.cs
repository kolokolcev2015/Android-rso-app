...
namespace App5
{
    ...
    public class AllEvents : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        private RecyclerView recycler;
        private RecyclerViewAdapterEvents adapter;
        private RecyclerView.LayoutManager layoutManager;
        private List<DataEvents> lstData = new List<DataEvents>();
        List<DataEvents> Devents = new List<DataEvents>();
        ...
        {
            Intent intent = new Intent(this, typeof(InfoEvents));
            intent.PutExtra("image", Devents[position].image);
        ...
        {
            WebRequest request = WebRequest.Create("http://192.168.56.1/WebApplication1/Home/GetEventsRecycler");
            request.Method = "POST";
            string data = "";
            ...
            var dsql = JsonConvert.DeserializeObject<List<DataEvents>>(json_string);
            response.Close();
            return dsql;
        }
